...
check('community average is per sealed scored run over all traps', data.community.sealedRuns === 2 && data.community.averageResisted === 4.5 && data.community.possibleTraps === 11);
// sanity probe above: single clean run with the new engine resists 4 of 11
